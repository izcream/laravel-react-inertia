...
default_1((page) => createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./pages/${name}.tsx`, Object.assign({ "./pages/Booking.tsx": () => import("./assets/Booking.9a6d7524.mjs"), "./pages/Home.tsx": () => import("./assets/Home.2008e650.mjs") })),
  setup: ({
    App,
    props
  }) => /* @__PURE__ */ jsx(App, {
